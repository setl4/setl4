...
processing strings and text that was developed at Bell Labs in the
...
SETL4 requires SPITBOL V4.0 (or later), the binary of which can be found 
in the file `./bin/setl4'. 
...
SETL4 sets of kind _integer_ provide an efficient implementation of a set with
...
SETL4 provides the following operator symbols:
   ...
   _s @ e_     is equivalent to _filter(s,e)_
